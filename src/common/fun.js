...
4. data,page.total - Randomize multiple fields<br/>`
  ...
  "基本配置": "Basic Settings",
  "API规则": "API Rules",
  "设置API请求的匹配规则，可以是字符串或字符串数组": "Set API request matching rules, can be a string or string array",
  "请输入API规则": "Please enter API rules",
  "例如: /api": "Example: /api",
  "配置路径": "Config Path",
  "配置文件的路径": "Path to the configuration file",
  "例如: ./config": "Example: ./config",
  "启用HTTPS": "Enable HTTPS",
  "是否启用HTTPS": "Whether to enable HTTPS",
  "缓存请求历史最大长度": "Max Cache Request History Length",
  "缓存请求历史的最大长度": "Maximum length of cached request history",
  "语言": "Language",
  ...
  "设置按钮的位置": "Set the position of the button",
  "顶部": "Top",
  "中间": "Middle",
  "底部": "Bottom",
